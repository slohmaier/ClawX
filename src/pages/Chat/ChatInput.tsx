      ...
      <div className="w-full">
          ...
          {selectedTarget && (
            <div className="px-2.5 pt-2 pb-1">
              <button
                ...
                aria-label={t('composer.clearTarget')}
              >
          ...
          <div className="flex items-end gap-1.5">
            ...
            >
              {sending ? (
                ...
                <SendHorizontal className="h-[18px] w-[18px]" strokeWidth={2} aria-hidden="true" />
              )}
            </Button>
          </div>
        </div>
        <div className="mt-2.5 flex items-center justify-between gap-2 text-[11px] text-muted-foreground/60 px-4">
          <div className="flex items-center gap-1.5" role="status" aria-live="polite">
            <div
              className={cn("w-1.5 h-1.5 rounded-full", gatewayStatus.state === 'running' ? "bg-green-500/80" : "bg-red-500/80")}
              aria-hidden="true"
            />
            <span>
